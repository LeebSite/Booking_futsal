...
<div class="container mx-auto p-5">
    ...
    <div class="bg-white shadow-md rounded p-4">
        ...
        <img src="{{ asset('storage/'.$pesanan->lapangan->foto) }}" alt="{{ $pesanan->lapangan->nama_lapangan }}" class="rounded w-full h-48 object-cover mt-4">
        ...
        <p><strong>Jam Mulai:</strong> {{ $pesanan->jam_mulai }}</p>
        <p><strong>Jam Selesai:</strong> {{ $pesanan->jam_selesai }}</p>
